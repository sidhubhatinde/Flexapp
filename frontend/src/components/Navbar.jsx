      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center space-x-11">
          <ul className="flex space-x-9 items-center">
            ...
            <li className="text-2xl"><Link to=''>Find talent</Link></li>
            <li className="text-2xl"><Link to=''>Find work</Link></li>
            <li className="text-2xl"><Link to=''>Why Flexwork</Link></li>
            <li className="text-2xl"><Link to=''>What's new</Link></li>
            <li className="text-2xl"><Link to=''>Pricing</Link></li>
          </ul>
        </div>
